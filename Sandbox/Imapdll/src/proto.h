...
// public methods:
	...
	RCODE FetchHeader (unsigned long msgno, char *section,
	...
	RCODE Copy (char *sequence, char *mailbox, long flags);

	RCODE Append (char *mailbox, char *flags, char *date, STRING *msg);
...
private:
	...
	RCODE Msgdata (unsigned long msgno,char *section,
	...
	ADDRESS *ParseAdrlist (char **txtptr, IMAPPARSEDREPLY *reply);

	ADDRESS *ParseAddress (char **txtptr, IMAPPARSEDREPLY *reply);
