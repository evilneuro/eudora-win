// QCMailboxCustomizeToolbarPage.cpp : implementation file
//
...
UINT	QCMailboxCustomizeToolbarPage::TranslateID(
UINT	uID )
{
	HTREEITEM			hItem;
	...
	hItem = m_theTreeCtrl.GetSelectedItem();
	...
	pCommand = ( ( QCMailboxTreeCtrl::CMboxTreeItemData* ) m_theTreeCtrl.GetItemData( hItem ) )->m_pCommand;
