...
pg_char PG_FAR control_commands[] = {
	"base basefont body br dir div dl head hr html li listing menu ol p style title ul wbr x-tab \0"
...
// QUALCOMM - added type and style
pg_char PG_FAR style_attributes[] = {
	"align color face size style type \0"
};
...
pg_char PG_FAR data_attributes[] = {
	"align alt bgcolor border cellpadding cellspacing colspan eudora height hspace href ismap lowsrc name src valign vspace width \0"
};
...
pg_char PG_FAR data_char_values[] = {
	"AElig Aacute Acirc Agrave Aring Atilde Auml Ccedil ETH Eacute Ecirc Egrave Euml Iacute Icirc Igrave Iuml Ntilde Oacute Ocirc Ograve Oslash Otilde Ouml THORN Uacute Ucirc Ugrave Uuml Yacute aacute acirc acute aelig agrave aring atilde auml brvbar ccedil cedil cent copy curren deg divide eacute ecirc egrave emdash eth euml frac12 frac14 frac34 iacute icirc iexcl igrave iquest iuml laquo macr micro middot nbsp not ntilde oacute ocirc ograve ordf ordm oslash otilde ouml para plusmn pound raquo reg sect shy szlig thorn trade uacute ucirc ugrave uml uuml yacute yen yuml \0"
};
...
// BEGIN QUALCOMM
// This is a bogus mapping under Windows, since this assumes the Mac character set
//pg_char PG_FAR data_chars[] = {
//	"®çåËÌ€‚*ƒæéè„îïñ¯Í…*òóô†*‡«‰¾ˆŒ‹Š*¢©Û¡ÖŽÑ*‘***’”Á“À•Çêëíìøµ*ÊÂ–—™˜»¼¿›š¦±£È¨¤Ð§*ªœž¬Ÿ*´Ø\0"
//};

// Here's something that works for Windows
pg_char PG_FAR data_chars[] = {
	"ÆÁÂÀÅÃÄÇÐÉÊÈËÍÎÌÏÑÓÔÓØÕÖÞÚÛÙÜÝáâ´æàåãä¦ç¸¢©¤°÷éêè­ðë½¼¾íî¡ì¿ï«¯µ· ¬ñóôòªºøõö¶±£»®§­ßþ™úûù¨üý¥ÿ\0"
};
// END QUALCOMM
