...
#define Static_SetIcon(hwndCtl, hIcon)          ((HICON)(UINT)(DWORD)SNDMSG((hwndCtl), STM_SETICON, (WPARAM)(HICON)(hIcon), 0L))
#define Static_GetIcon(hwndCtl, hIcon)          ((HICON)(UINT)(DWORD)SNDMSG((hwndCtl), STM_GETICON, 0L, 0L))
...
#define Edit_GetHandle(hwndCtl)                 ((HLOCAL)(UINT)(DWORD)SNDMSG((hwndCtl), EM_GETHANDLE, 0L, 0L))
#define Edit_SetHandle(hwndCtl, h)              ((void)SNDMSG((hwndCtl), EM_SETHANDLE, (WPARAM)(UINT)(HLOCAL)(h), 0L))
