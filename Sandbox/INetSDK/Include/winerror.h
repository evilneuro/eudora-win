...
// MessageText:
//
//  The message can only be used with synchronous operations only.
//
...
// MessageText:
//
//  An error occurred while installing the NT directory service. Please view the event log for more information.
//
...
// MessageText:
//
//  The file or directory is corrupted and nonreadable.
//
...
// MessageText:
//
//  The disk structure is corrupted and nonreadable.
//
...
// MessageText:
//
//  The requested operation did not satisfy one or more constraints associated with the class of the obect.
//
...
// MessageText:
//
//  No media is current available in this media pool or library.
//
...
// MessageText:
//
//  Unable to read or write to the database.
//
