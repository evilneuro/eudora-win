...
#if (defined(_M_MRX000) || defined(_M_ALPHA)) && (_MSC_VER >= 1100) && !(defined(MIDL_PASS) || defined(RC_INVOKED))
...
#define JOB_OBJECT_ALL_ACCESS       (STANDARD_RIGHTS_REQUIRED | SYNCHRONIZE | 0xF )
...
#define JOB_OBJECT_LIMIT_VALID_FLAGS        0x0000003f
...
#define PROCESSOR_ARCHITECTURE_SH    4
...
typedef struct _MEMORY_BASIC_INFORMATION_VLM {
    union {
        PVOID64 BaseAddress;
        DWORDLONG BaseAddressAsUlongLong;
    };
    union {
        PVOID64 AllocationBase;
        DWORDLONG AllocationBaseAsUlongLong;
    };
...
#define IO_REPARSE_TAG_SYMBOLIC_LINK             (2)
#define IO_REPARSE_TAG_DFS                       (3)
#define IO_REPARSE_TAG_HSM                       (4)
#define IO_REPARSE_TAG_NSS                       (5)
#define IO_REPARSE_TAG_MOUNT_POINT               (6)
#define IO_REPARSE_TAG_SIS                       (7)
#define IO_REPARSE_TAG_NSSRECOVER                (8)
#define IO_REPARSE_TAG_RESERVED_MS_RANGE         (256)
...
#define BooleanIsSlowTag(_Tag) (                 \
     (BOOLEAN)((_Tag) == (IO_REPARSE_TAG_HSM))   \
     )
...
#define ACCESS_DS_SOURCE_A "Directory Service"
#define ACCESS_DS_SOURCE_W L"Directory Service"
...
#define IMAGE_SUBSYSTEM_WINDOWS_CE_GUI       4   // Image runs in the Windows CE subsystem.
#define IMAGE_SUBSYSTEM_OS2_CUI              5   // image runs in the OS/2 character subsystem.
#define IMAGE_SUBSYSTEM_POSIX_CUI            7   // image runs in the Posix character subsystem.
#define IMAGE_SUBSYSTEM_RESERVED8            8   // image runs in the 8 subsystem.
...
typedef struct _IMAGE_CRUNTIME_FUNCTION_ENTRY {
    DWORD FuncStart : 32;
    DWORD PrologLen : 8;
    DWORD FuncLen : 23;
    DWORD ExceptionFlag : 1;
} IMAGE_CRUNTIME_FUNCTION_ENTRY, *PIMAGE_CRUNTIME_FUNCTION_ENTRY;
