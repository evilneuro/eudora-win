...
#define NewColorChangedProc(userRoutine) 						(ColorChangedUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppColorChangedProcInfo, GetCurrentArchitecture())
#define NewNColorChangedProc(userRoutine) 						(NColorChangedUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppNColorChangedProcInfo, GetCurrentArchitecture())
#define NewUserEventProc(userRoutine) 							(UserEventUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppUserEventProcInfo, GetCurrentArchitecture())
#define CallColorChangedProc(userRoutine, userData, newColor) 	CALL_TWO_PARAMETER_UPP((userRoutine), uppColorChangedProcInfo, (userData), (newColor))
#define CallNColorChangedProc(userRoutine, userData, newColor) 	CALL_TWO_PARAMETER_UPP((userRoutine), uppNColorChangedProcInfo, (userData), (newColor))
#define CallUserEventProc(userRoutine, event) 					CALL_ONE_PARAMETER_UPP((userRoutine), uppUserEventProcInfo, (event))
