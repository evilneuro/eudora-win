...
enum {
	...
	siCompressionChannels		= FOUR_CHAR_CODE('cpct'),		/*compressor's number of channels*/
	...
	siCompressionSampleRate		= FOUR_CHAR_CODE('cprt'),		/*compressor's sample rate*/
...
enum {
	...
	kWaveInSubType				= FOUR_CHAR_CODE('wavi'),		/*Windows Wave*/
	...
	kWaveOutSubType				= FOUR_CHAR_CODE('wavo'),		/*Windows Wave*/
	kDirectSoundSubType			= FOUR_CHAR_CODE('dsnd'),		/*Direct Sound*/
	...
	kSoundPortHandlerType		= FOUR_CHAR_CODE('soph'),		/*sound output port handler component*/
	kAwacsGCSubType				= FOUR_CHAR_CODE('awgc'),		/*awacs GC port handler*/
	kSoundOutPortType			= FOUR_CHAR_CODE('sopt'),		/*sound output port component*/
	kIntSpkrSubType				= FOUR_CHAR_CODE('ispk'),		/*internal speaker*/
	kHeadphonesSubType			= FOUR_CHAR_CODE('hdpn'),		/*headphones*/
	kExtSpkrSubType				= FOUR_CHAR_CODE('espk'),		/*external speaker*/
	kEffectSubType				= FOUR_CHAR_CODE('efct'),		/*effect (like SRS or some other DSP function)*/
	kSubwooferSubType			= FOUR_CHAR_CODE('subw'),		/*subwoofer*/
	kSoundPowerType				= FOUR_CHAR_CODE('spwr'),		/*sound power component*/
	kPowerAwacsSubType			= FOUR_CHAR_CODE('awac'),		/*awacs power*/
	kPowerScreamerSubType		= FOUR_CHAR_CODE('scrm')		/*screamer power*/
};
...
enum { uppSICCompletionProcInfo = 0x000000C0 }; 				/* pascal no_return_value Func(4_bytes) */
#define NewSICCompletionProc(userRoutine) 						(SICCompletionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSICCompletionProcInfo, GetCurrentArchitecture())
#define CallSICCompletionProc(userRoutine, SICParmPtr) 			CALL_ONE_PARAMETER_UPP((userRoutine), uppSICCompletionProcInfo, (SICParmPtr))
#endif  /*  !TARGET_OS_MAC */
