...
#define NewATAClientProc(userRoutine) 							(ATAClientUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppATAClientProcInfo, GetCurrentArchitecture())
#define CallATAClientProc(userRoutine, ataERPtr) 				CALL_ONE_PARAMETER_UPP((userRoutine), uppATAClientProcInfo, (ataERPtr))
...
#define NewATADispatchProc(userRoutine) 						(ATADispatchUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppATADispatchProcInfo, GetCurrentArchitecture())
#define CallATADispatchProc(userRoutine, pb) 					CALL_ONE_PARAMETER_UPP((userRoutine), uppATADispatchProcInfo, (pb))
EXTERN_API( SInt16 )
