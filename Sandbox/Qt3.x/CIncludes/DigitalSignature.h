...
#define NewSIGStatusProc(userRoutine) 							(SIGStatusUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSIGStatusProcInfo, GetCurrentArchitecture())
#define CallSIGStatusProc(userRoutine) 							CALL_ZERO_PARAMETER_UPP((userRoutine), uppSIGStatusProcInfo)
/*
...
SIGSign							(SIGContextPtr 			context,
								 ...
								 SIGStatusProcPtr 		statusProc)							FOURWORDINLINE(0x203C, 0x0006, 0x076F, 0xAA5D);
...
SIGVerifyPrepare				(SIGContextPtr 			context,
								 SIGSignaturePtr 		signature,
								 Size 					signatureSize,
								 SIGStatusProcPtr 		statusProc)							FOURWORDINLINE(0x203C, 0x0008, 0x0770, 0xAA5D);
...
SIGSignFile						(SIGContextPtr 			context,
								 ...
								 SIGStatusProcPtr 		statusProc)							FOURWORDINLINE(0x203C, 0x0008, 0x09C5, 0xAA5D);

EXTERN_API( OSErr )
SIGVerifyFile					(SIGContextPtr 			context,
								 const FSSpec *			fileSpec,
								 SIGStatusProcPtr 		statusProc)							FOURWORDINLINE(0x203C, 0x0006, 0x09C6, 0xAA5D);
