...
#define NewPanelBusyProc(userRoutine) 							(PanelBusyUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppPanelBusyProcInfo, GetCurrentArchitecture())
#define CallPanelBusyProc(userRoutine, Panel, busy) 			CALL_TWO_PARAMETER_UPP((userRoutine), uppPanelBusyProcInfo, (Panel), (busy))
...
#define NewFindPanelBusyProc(userRoutine) 						(FindPanelBusyUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppFindPanelBusyProcInfo, GetCurrentArchitecture())
#define CallFindPanelBusyProc(userRoutine, findPanel, busy) 	CALL_TWO_PARAMETER_UPP((userRoutine), uppFindPanelBusyProcInfo, (findPanel), (busy))
