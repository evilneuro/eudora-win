...
#define NewSlotIntServiceProc(userRoutine) 						(SlotIntServiceUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSlotIntServiceProcInfo, GetCurrentArchitecture())
#if TARGET_OS_MAC && TARGET_CPU_68K && !TARGET_RT_MAC_CFM
	#pragma parameter __D0 CallSlotIntServiceProc(__A0, __A1)
	short CallSlotIntServiceProc(SlotIntServiceUPP routine, long sqParameter) = 0x4E90;
#else
	#define CallSlotIntServiceProc(userRoutine, sqParameter) 	CALL_ONE_PARAMETER_UPP((userRoutine), uppSlotIntServiceProcInfo, (sqParameter))
#endif
