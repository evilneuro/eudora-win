...
#define NewSRCallBackProc(userRoutine) 							(SRCallBackUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppSRCallBackProcInfo, GetCurrentArchitecture())
#define CallSRCallBackProc(userRoutine, param) 					CALL_ONE_PARAMETER_UPP((userRoutine), uppSRCallBackProcInfo, (param))
