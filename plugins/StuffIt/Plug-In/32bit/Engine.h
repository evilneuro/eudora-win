...
// miscellaneous
engineAPI int32 engineMajorVersion();
engineAPI int32 engineMinorVersion();
engineAPI int32 engineBuildNumber();
engineAPI int32 engineBuildType();
engineAPI int32 engineDebugLevel();
engineAPI int32 engineReleaseYear();
engineAPI int32 engineReleaseMonth();
engineAPI int32 engineReleaseDay();
engineAPI int32 engineReleaseHour();
engineAPI int32 engineReleaseMinute();
...
engineAPI bool scanArchive(archiveReader);
...
engineAPI bool decodeArchive(archiveReader);
...
// called when archive format does not contain any fileName
...
engineAPI bool createArchive(const char* fileList[], archiveWriter);
