...
# ADD BASE CPP /nologo /MD /GS /GL /W4 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /Fp"OTlib50R/OTlib50R.pch" /YX"stdafx.h" /c
# ADD CPP /nologo /MD /GS /GL /W4 /Gm- /GR /GX /Zi /O1 /I "..\src" /I "..\..\src" /I "..\include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /Fp"OTA50R/OTA50R.pch" /Yu"stdafx.h" /c
CPP_PROJ=/nologo /MD /GS /GL /W4 /Gm- /GR /GX /Zi /O1 /I "..\src" /I "..\..\src" /I "..\include" /D\
...
LIB32=link.exe -lib
# ADD BASE LIB32 /nologo /LTCG /out:"OTlib50R\OTlib50R.lib"
# ADD LIB32 /nologo /LTCG /out:"OTA50R\OTA50R.lib"
LIB32_FLAGS=/nologo /LTCG /out:"$(OUTDIR)/OTA50R.lib" 
LIB32_OBJS= \
	"$(INTDIR)\Adler32.obj" \
	"$(INTDIR)\Blackbox.obj" \
	"$(INTDIR)\browedit.obj" \
...
ALL : "$(OUTDIR)\OTA50D.lib" "$(OUTDIR)\OTA50D.bsc"
...
CLEAN : 
	...
	-@erase "$(INTDIR)\Blackbox.sbr"
	-@erase "$(INTDIR)\browedit.sbr"
	-@erase "$(INTDIR)\CalcBtn.sbr"
	-@erase "$(INTDIR)\Calendar.sbr"
	-@erase "$(INTDIR)\CalTitle.sbr"
	-@erase "$(INTDIR)\compfile.sbr"
	-@erase "$(INTDIR)\Compress.sbr"
	-@erase "$(INTDIR)\Crc32.sbr"
	-@erase "$(INTDIR)\Cryptfil.sbr"
	-@erase "$(INTDIR)\curredit.sbr"
	-@erase "$(INTDIR)\DayBar.sbr"
	-@erase "$(INTDIR)\DayBox.sbr"
	-@erase "$(INTDIR)\Deflate.sbr"
	-@erase "$(INTDIR)\DropEdit.sbr"
	-@erase "$(INTDIR)\DTButton.sbr"
	-@erase "$(INTDIR)\DTChange.sbr"
	-@erase "$(INTDIR)\DTCtrl.sbr"
	-@erase "$(INTDIR)\DTGadget.sbr"
	-@erase "$(INTDIR)\DTList.sbr"
	-@erase "$(INTDIR)\DTNumerc.sbr"
	-@erase "$(INTDIR)\DTParser.sbr"
	-@erase "$(INTDIR)\DTSpin.sbr"
	-@erase "$(INTDIR)\DTStatic.sbr"
	-@erase "$(INTDIR)\fdichild.sbr"
	-@erase "$(INTDIR)\fdimain.sbr"
	...
	-@erase "$(INTDIR)\lstbxclr.sbr"
	-@erase "$(INTDIR)\lstbxedt.sbr"
	-@erase "$(INTDIR)\Panel.sbr"
	-@erase "$(INTDIR)\Panview.sbr"
	-@erase "$(INTDIR)\Panwnd.sbr"
	-@erase "$(INTDIR)\Rotor.sbr"
	-@erase "$(INTDIR)\sbarcore.sbr"
	-@erase "$(INTDIR)\sbarcust.sbr"
	-@erase "$(INTDIR)\sbardlg.sbr"
	-@erase "$(INTDIR)\sbardock.sbr"
	-@erase "$(INTDIR)\sbarmgr.sbr"
	-@erase "$(INTDIR)\sbarstat.sbr"
	-@erase "$(INTDIR)\Sbartool.sbr"
	-@erase "$(INTDIR)\SCutAccl.sbr"
	-@erase "$(INTDIR)\SCutCmds.sbr"
	-@erase "$(INTDIR)\SCutDlg.sbr"
	-@erase "$(INTDIR)\SCutKDlg.sbr"
	-@erase "$(INTDIR)\sdockcnt.sbr"
	-@erase "$(INTDIR)\sdocksta.sbr"
	-@erase "$(INTDIR)\secaux.sbr"
	-@erase "$(INTDIR)\SECBMPDG.sbr"
	-@erase "$(INTDIR)\secbtns.sbr"
	-@erase "$(INTDIR)\SecCalc.sbr"
	-@erase "$(INTDIR)\seccomp.sbr"
	-@erase "$(INTDIR)\secdib.sbr"
	-@erase "$(INTDIR)\secdsp.sbr"
	-@erase "$(INTDIR)\secgif.sbr"
	-@erase "$(INTDIR)\secimage.sbr"
	-@erase "$(INTDIR)\secjpeg.sbr"
	-@erase "$(INTDIR)\secmedit.sbr"
	-@erase "$(INTDIR)\secpcx.sbr"
	-@erase "$(INTDIR)\secrand.sbr"
	-@erase "$(INTDIR)\secreg.sbr"
	-@erase "$(INTDIR)\SECSPLSH.sbr"
	-@erase "$(INTDIR)\sectarga.sbr"
	-@erase "$(INTDIR)\sectiff.sbr"
	-@erase "$(INTDIR)\sectlf.sbr"
	-@erase "$(INTDIR)\sectnbmp.sbr"
	-@erase "$(INTDIR)\sectndc.sbr"
	-@erase "$(INTDIR)\sectndlg.sbr"
	-@erase "$(INTDIR)\sectndoc.sbr"
	-@erase "$(INTDIR)\sectnvw.sbr"
	-@erase "$(INTDIR)\sectnwin.sbr"
	-@erase "$(INTDIR)\SECTOD.sbr"
	-@erase "$(INTDIR)\secwb.sbr"
	-@erase "$(INTDIR)\secwell.sbr"
	-@erase "$(INTDIR)\secwsmgr.sbr"
	-@erase "$(INTDIR)\slocale.sbr"
	-@erase "$(INTDIR)\slstctip.sbr"
	-@erase "$(INTDIR)\slstctl.sbr"
	-@erase "$(INTDIR)\Stdafx.sbr"
	-@erase "$(INTDIR)\swinfrm.sbr"
	-@erase "$(INTDIR)\swinmdi.sbr"
	-@erase "$(INTDIR)\tabctrl.sbr"
	-@erase "$(INTDIR)\tabctrl3.sbr"
	-@erase "$(INTDIR)\tabctrlb.sbr"
	-@erase "$(INTDIR)\tabwnd.sbr"
	-@erase "$(INTDIR)\tabwnd3.sbr"
	-@erase "$(INTDIR)\tabwndb.sbr"
	-@erase "$(INTDIR)\tbarcust.sbr"
	-@erase "$(INTDIR)\tbarmgr.sbr"
	-@erase "$(INTDIR)\tbarpage.sbr"
	-@erase "$(INTDIR)\tbarsdlg.sbr"
	-@erase "$(INTDIR)\tbartrck.sbr"
	-@erase "$(INTDIR)\tbtn2prt.sbr"
	-@erase "$(INTDIR)\tbtncmbo.sbr"
	-@erase "$(INTDIR)\tbtnstd.sbr"
	-@erase "$(INTDIR)\tbtnwnd.sbr"
	-@erase "$(INTDIR)\Tif_aux.sbr"
	-@erase "$(INTDIR)\Tif_ccit.sbr"
	-@erase "$(INTDIR)\Tif_clos.sbr"
	-@erase "$(INTDIR)\Tif_comp.sbr"
	-@erase "$(INTDIR)\Tif_dir.sbr"
	-@erase "$(INTDIR)\Tif_diri.sbr"
	-@erase "$(INTDIR)\Tif_dirr.sbr"
	-@erase "$(INTDIR)\Tif_dirw.sbr"
	-@erase "$(INTDIR)\Tif_dump.sbr"
	-@erase "$(INTDIR)\Tif_erro.sbr"
	-@erase "$(INTDIR)\Tif_fax3.sbr"
	-@erase "$(INTDIR)\Tif_fax4.sbr"
	-@erase "$(INTDIR)\Tif_flus.sbr"
	-@erase "$(INTDIR)\Tif_geti.sbr"
	-@erase "$(INTDIR)\Tif_jpeg.sbr"
	-@erase "$(INTDIR)\Tif_lzw.sbr"
	-@erase "$(INTDIR)\Tif_msdo.sbr"
	-@erase "$(INTDIR)\Tif_open.sbr"
	-@erase "$(INTDIR)\Tif_pack.sbr"
	-@erase "$(INTDIR)\Tif_prin.sbr"
	-@erase "$(INTDIR)\Tif_read.sbr"
	-@erase "$(INTDIR)\Tif_stri.sbr"
	-@erase "$(INTDIR)\Tif_swab.sbr"
	-@erase "$(INTDIR)\Tif_thun.sbr"
	-@erase "$(INTDIR)\Tif_tile.sbr"
	-@erase "$(INTDIR)\Tif_vers.sbr"
	-@erase "$(INTDIR)\Tif_warn.sbr"
	-@erase "$(INTDIR)\Tif_writ.sbr"
	-@erase "$(INTDIR)\TrCtlX.sbr"
	-@erase "$(INTDIR)\TreeNode.sbr"
	-@erase "$(INTDIR)\Trees.sbr"
	-@erase "$(INTDIR)\Uncompr.sbr"
	-@erase "$(INTDIR)\usertool.sbr"
	-@erase "$(INTDIR)\usrtldlg.sbr"
	-@erase "$(INTDIR)\Zoomview.sbr"
	-@erase "$(INTDIR)\Zutil.sbr"
	-@erase "$(OUTDIR)\OTA50D.bsc"
	-@erase "$(OUTDIR)\OTA50D.lib"

"$(OUTDIR)" :
    if not exist "$(OUTDIR)/$(NULL)" mkdir "$(OUTDIR)"

# ADD BASE CPP /nologo /MDd /RTC1 /GS /W4 /GX /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /FR"$(INTDIR)/" /Fp"OTlib50D/OTlib50D.pch" /YX"stdafx.h" /c
# ADD CPP /nologo /MDd /RTC1 /GS /W4 /Gm /Gi /GR /GX /Zi /Od /I "..\src" /I "..\..\src" /I "..\include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /FR"$(INTDIR)/" /Fp"OTA50D/OTA50D.pch" /Yu"stdafx.h" /Fd"OTA50D/OTA50D.pdb" /GZ /c
CPP_PROJ=/nologo /MDd /RTC1 /GS /W4 /Gm /Gi /GR /GX /Zi /Od /I "..\src" /I "..\..\src" /I\
 "..\include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS"\
 /FR"$(INTDIR)/" /Fp"$(INTDIR)/OTA50D.pch" /Yu"stdafx.h" /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/OTA50D.pdb" /GZ /c 
CPP_OBJS=.\OTA50D/
CPP_SBRS=.\.
BSC32=bscmake.exe
...
"$(OUTDIR)\OTA50D.bsc" : "$(OUTDIR)" $(BSC32_SBRS)
    $(BSC32) @<<
...
BuildCmds= \
	$(CPP) /nologo /MD /GS /GL /W4 /Gm- /GR /GX /Zi /O1 /I "..\src" /I "..\..\src" /I "..\include" /D\
 "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS"\
...
BuildCmds= \
	$(CPP) /nologo /MDd /RTC1 /GS /W4 /Gm /Gi /GR /GX /Zi /Od /I "..\src" /I "..\..\src" /I\
 "..\include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS"\
 /FR"$(OUTDIR)/" /Fp"$(INTDIR)/OTA50D.pch" /Yc /Fo"$(INTDIR)/" /Fd"$(INTDIR)/OTA50D.pdb" /GZ /c\
 $(SOURCE) \
