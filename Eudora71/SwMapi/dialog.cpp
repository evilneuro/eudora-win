...
BEGIN_MESSAGE_MAP(CSwitchDialog, CDialog)
	...
	ON_BN_CLICKED(IDC_INSTALL_NETSCAPE, OnInstallEudoraAsNetscapeMailHandler)
	ON_BN_CLICKED(IDC_UNINSTALL_NETSCAPE, OnUnInstallEudoraAsNetscapeMailHandler)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
void CSwitchDialog::OnInstallEudoraAsNetscapeMailHandler() 
{
	((CSwitchApp *)AfxGetApp())->InstallEudoraAsNetscapeMailHandler();
	
}

void CSwitchDialog::OnUnInstallEudoraAsNetscapeMailHandler() 
{
	((CSwitchApp *)AfxGetApp())->UnInstallEudoraAsNetscapeMailHandler();
}
