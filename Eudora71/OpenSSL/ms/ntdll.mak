...
PLATFORM=VC-WIN32
CC=cl
CFLAG= /MD /W3 /WX /Ox /O2 /Ob2 /Gs0 /GF /Gy /nologo -DOPENSSL_SYSNAME_WIN32 -DWIN32_LEAN_AND_MEAN -DL_ENDIAN -DDSO_WIN32 -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -DBN_ASM -DMD5_ASM -DSHA1_ASM -DRMD160_ASM /Fdout32dll -DOPENSSL_NO_KRB5    
APP_CFLAG=
LIB_CFLAG= -D_WINDLL
SHLIB_CFLAG=
...
$(OBJ_D)\ecp_recp.obj: $(SRC_D)\crypto\ec\ecp_recp.c
	$(CC) /Fo$(OBJ_D)\ecp_recp.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\crypto\ec\ecp_recp.c
...
$(OBJ_D)\v3_hex.obj: $(SRC_D)\crypto\x509v3\v3_hex.c
	$(CC) /Fo$(OBJ_D)\v3_hex.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\crypto\x509v3\v3_hex.c
...
$(OBJ_D)\hw_atalla.obj: $(SRC_D)\crypto\engine\hw_atalla.c
	$(CC) /Fo$(OBJ_D)\hw_atalla.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\crypto\engine\hw_atalla.c

$(OBJ_D)\hw_cswift.obj: $(SRC_D)\crypto\engine\hw_cswift.c
	$(CC) /Fo$(OBJ_D)\hw_cswift.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\crypto\engine\hw_cswift.c

$(OBJ_D)\hw_ncipher.obj: $(SRC_D)\crypto\engine\hw_ncipher.c
	$(CC) /Fo$(OBJ_D)\hw_ncipher.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\crypto\engine\hw_ncipher.c

$(OBJ_D)\hw_nuron.obj: $(SRC_D)\crypto\engine\hw_nuron.c
	$(CC) /Fo$(OBJ_D)\hw_nuron.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\crypto\engine\hw_nuron.c

$(OBJ_D)\hw_ubsec.obj: $(SRC_D)\crypto\engine\hw_ubsec.c
	$(CC) /Fo$(OBJ_D)\hw_ubsec.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\crypto\engine\hw_ubsec.c

$(OBJ_D)\hw_cryptodev.obj: $(SRC_D)\crypto\engine\hw_cryptodev.c
	$(CC) /Fo$(OBJ_D)\hw_cryptodev.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\crypto\engine\hw_cryptodev.c

$(OBJ_D)\hw_aep.obj: $(SRC_D)\crypto\engine\hw_aep.c
	$(CC) /Fo$(OBJ_D)\hw_aep.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\crypto\engine\hw_aep.c

$(OBJ_D)\hw_sureware.obj: $(SRC_D)\crypto\engine\hw_sureware.c
	$(CC) /Fo$(OBJ_D)\hw_sureware.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\crypto\engine\hw_sureware.c

$(OBJ_D)\hw_4758_cca.obj: $(SRC_D)\crypto\engine\hw_4758_cca.c
	$(CC) /Fo$(OBJ_D)\hw_4758_cca.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\crypto\engine\hw_4758_cca.c
...
$(OBJ_D)\fips.obj: $(SRC_D)\fips-1.0\fips.c
	$(CC) /Fo$(OBJ_D)\fips.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\fips.c

$(OBJ_D)\fips_err_wrapper.obj: $(SRC_D)\fips-1.0\fips_err_wrapper.c
	$(CC) /Fo$(OBJ_D)\fips_err_wrapper.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\fips_err_wrapper.c

$(OBJ_D)\fipshashes.obj: $(SRC_D)\fips-1.0\fipshashes.c
	$(CC) /Fo$(OBJ_D)\fipshashes.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\fipshashes.c

$(OBJ_D)\fips_aes_core.obj: $(SRC_D)\fips-1.0\aes\fips_aes_core.c
	$(CC) /Fo$(OBJ_D)\fips_aes_core.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\aes\fips_aes_core.c

$(OBJ_D)\fips_aes_selftest.obj: $(SRC_D)\fips-1.0\aes\fips_aes_selftest.c
	$(CC) /Fo$(OBJ_D)\fips_aes_selftest.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\aes\fips_aes_selftest.c

$(OBJ_D)\fips_des_enc.obj: $(SRC_D)\fips-1.0\des\fips_des_enc.c
	$(CC) /Fo$(OBJ_D)\fips_des_enc.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\des\fips_des_enc.c

$(OBJ_D)\fips_des_selftest.obj: $(SRC_D)\fips-1.0\des\fips_des_selftest.c
	$(CC) /Fo$(OBJ_D)\fips_des_selftest.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\des\fips_des_selftest.c

$(OBJ_D)\fips_set_key.obj: $(SRC_D)\fips-1.0\des\fips_set_key.c
	$(CC) /Fo$(OBJ_D)\fips_set_key.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\des\fips_set_key.c

$(OBJ_D)\fips_dsa_ossl.obj: $(SRC_D)\fips-1.0\dsa\fips_dsa_ossl.c
	$(CC) /Fo$(OBJ_D)\fips_dsa_ossl.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\dsa\fips_dsa_ossl.c

$(OBJ_D)\fips_dsa_gen.obj: $(SRC_D)\fips-1.0\dsa\fips_dsa_gen.c
	$(CC) /Fo$(OBJ_D)\fips_dsa_gen.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\dsa\fips_dsa_gen.c

$(OBJ_D)\fips_dsa_selftest.obj: $(SRC_D)\fips-1.0\dsa\fips_dsa_selftest.c
	$(CC) /Fo$(OBJ_D)\fips_dsa_selftest.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\dsa\fips_dsa_selftest.c

$(OBJ_D)\fips_dh_check.obj: $(SRC_D)\fips-1.0\dh\fips_dh_check.c
	$(CC) /Fo$(OBJ_D)\fips_dh_check.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\dh\fips_dh_check.c

$(OBJ_D)\fips_dh_gen.obj: $(SRC_D)\fips-1.0\dh\fips_dh_gen.c
	$(CC) /Fo$(OBJ_D)\fips_dh_gen.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\dh\fips_dh_gen.c

$(OBJ_D)\fips_dh_key.obj: $(SRC_D)\fips-1.0\dh\fips_dh_key.c
	$(CC) /Fo$(OBJ_D)\fips_dh_key.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\dh\fips_dh_key.c

$(OBJ_D)\fips_hmac.obj: $(SRC_D)\fips-1.0\hmac\fips_hmac.c
	$(CC) /Fo$(OBJ_D)\fips_hmac.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\hmac\fips_hmac.c

$(OBJ_D)\fips_hmac_selftest.obj: $(SRC_D)\fips-1.0\hmac\fips_hmac_selftest.c
	$(CC) /Fo$(OBJ_D)\fips_hmac_selftest.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\hmac\fips_hmac_selftest.c

$(OBJ_D)\fips_rand.obj: $(SRC_D)\fips-1.0\rand\fips_rand.c
	$(CC) /Fo$(OBJ_D)\fips_rand.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\rand\fips_rand.c

$(OBJ_D)\fips_rand_selftest.obj: $(SRC_D)\fips-1.0\rand\fips_rand_selftest.c
	$(CC) /Fo$(OBJ_D)\fips_rand_selftest.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\rand\fips_rand_selftest.c

$(OBJ_D)\fips_rsa_eay.obj: $(SRC_D)\fips-1.0\rsa\fips_rsa_eay.c
	$(CC) /Fo$(OBJ_D)\fips_rsa_eay.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\rsa\fips_rsa_eay.c

$(OBJ_D)\fips_rsa_gen.obj: $(SRC_D)\fips-1.0\rsa\fips_rsa_gen.c
	$(CC) /Fo$(OBJ_D)\fips_rsa_gen.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\rsa\fips_rsa_gen.c

$(OBJ_D)\fips_rsa_selftest.obj: $(SRC_D)\fips-1.0\rsa\fips_rsa_selftest.c
	$(CC) /Fo$(OBJ_D)\fips_rsa_selftest.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\rsa\fips_rsa_selftest.c

$(OBJ_D)\fips_rsa_x931g.obj: $(SRC_D)\fips-1.0\rsa\fips_rsa_x931g.c
	$(CC) /Fo$(OBJ_D)\fips_rsa_x931g.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\rsa\fips_rsa_x931g.c

$(OBJ_D)\fips_sha1dgst.obj: $(SRC_D)\fips-1.0\sha\fips_sha1dgst.c
	$(CC) /Fo$(OBJ_D)\fips_sha1dgst.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\sha\fips_sha1dgst.c

$(OBJ_D)\fips_sha1_selftest.obj: $(SRC_D)\fips-1.0\sha\fips_sha1_selftest.c
	$(CC) /Fo$(OBJ_D)\fips_sha1_selftest.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\sha\fips_sha1_selftest.c

$(OBJ_D)\fips_sha256.obj: $(SRC_D)\fips-1.0\sha\fips_sha256.c
	$(CC) /Fo$(OBJ_D)\fips_sha256.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\sha\fips_sha256.c

$(OBJ_D)\fips_sha512.obj: $(SRC_D)\fips-1.0\sha\fips_sha512.c
	$(CC) /Fo$(OBJ_D)\fips_sha512.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -c $(SRC_D)\fips-1.0\sha\fips_sha512.c
