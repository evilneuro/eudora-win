...
HEADER=$(INCL_D)\e_os.h \
	...
	$(INCL_D)\o_time.h $(INCL_D)\md4_locl.h $(INCL_D)\md5_locl.h \
	...
	$(INCL_D)\rc5_locl.h $(INCL_D)\idea_lcl.h $(INCL_D)\bf_pi.h \
	$(INCL_D)\bf_locl.h $(INCL_D)\cast_s.h $(INCL_D)\cast_lcl.h \
	$(INCL_D)\aes_locl.h $(INCL_D)\bn_lcl.h $(INCL_D)\bn_prime.h \
	$(INCL_D)\ec_lcl.h $(INCL_D)\bss_file.c $(INCL_D)\obj_dat.h \
	$(INCL_D)\conf_def.h $(INCL_D)\ui_locl.h $(INCL_D)\ssl_locl.h \
...
EXHEADER=$(INCO_D)\e_os2.h \
	...
	$(INCO_D)\krb5_asn.h $(INCO_D)\ssl.h $(INCO_D)\ssl2.h \
...
T_OBJ=$(OBJ_D)\md2test.obj \
	...
	$(OBJ_D)\evp_test.obj $(OBJ_D)\enginetest.obj $(OBJ_D)\ssltest.obj
...
CRYPTOOBJ=$(OBJ_D)\cryptlib.obj \
	...
	$(OBJ_D)\o_time.obj $(OBJ_D)\md2_dgst.obj $(OBJ_D)\md2_one.obj \
	...
	$(OBJ_D)\v3_ocsp.obj $(OBJ_D)\v3_akeya.obj $(OBJ_D)\conf_err.obj \
	...
	$(OBJ_D)\tb_rsa.obj $(OBJ_D)\tb_dsa.obj $(OBJ_D)\tb_dh.obj \
	$(OBJ_D)\tb_rand.obj $(OBJ_D)\tb_cipher.obj $(OBJ_D)\tb_digest.obj \
	$(OBJ_D)\eng_openssl.obj $(OBJ_D)\eng_dyn.obj $(OBJ_D)\eng_cnf.obj \
	$(OBJ_D)\hw_atalla.obj $(OBJ_D)\hw_cswift.obj $(OBJ_D)\hw_ncipher.obj \
	$(OBJ_D)\hw_nuron.obj $(OBJ_D)\hw_ubsec.obj $(OBJ_D)\hw_cryptodev.obj \
	$(OBJ_D)\hw_aep.obj $(OBJ_D)\hw_sureware.obj $(OBJ_D)\hw_4758_cca.obj \
...
T_EXE=$(TEST_D)\md2test.exe \
	...
	$(TEST_D)\evp_test.exe $(TEST_D)\enginetest.exe $(TEST_D)\ssltest.exe
...
$(OBJ_D)\cversion.obj: $(SRC_D)\crypto\cversion.c
	$(CC) /Fo$(OBJ_D)\cversion.obj  $(SHLIB_CFLAGS) -DOPENSSL_BUILD_SHLIBCRYPTO -DMK1MF_BUILD -DMK1MF_PLATFORM_VC_W31_32 -c $(SRC_D)\crypto\cversion.c
...
$(TEST_D)\enginetest.exe: $(OBJ_D)\enginetest.obj $(LIBS_DEP)
  $(LINK) $(LFLAGS) @<<
  $(APP_EX_OBJ) $(OBJ_D)\enginetest.obj
  $(TEST_D)\enginetest.exe
...
$(O_CRYPTO): $(CRYPTOOBJ)
  ...
  $(OBJ_D)\fcrypt_b.obj +
  $(OBJ_D)\hmac.obj +
  $(OBJ_D)\hw_4758_cca.obj +
  $(OBJ_D)\hw_aep.obj +
  $(OBJ_D)\hw_atalla.obj +
  $(OBJ_D)\hw_cryptodev.obj +
  $(OBJ_D)\hw_cswift.obj +
  $(OBJ_D)\hw_ncipher.obj +
  $(OBJ_D)\hw_nuron.obj +
  $(OBJ_D)\hw_sureware.obj +
  $(OBJ_D)\hw_ubsec.obj +
  $(OBJ_D)\i2d_pr.obj +
  $(OBJ_D)\i2d_pu.obj +
  $(OBJ_D)\i_cbc.obj +
