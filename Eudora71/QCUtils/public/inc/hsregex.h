...
public:
	...
	CRegex(CString strRegex, bool bCaseInsensitive = true);
	CRegex(const CRegex & in_copy);
	~CRegex();
	bool Compile(CString strRegex, bool bCaseInsensitive = true);
	CString GetErrorText();
	bool Match(const char *szText);
};
