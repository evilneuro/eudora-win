...
*/
	...
	EXTERN_API( ComponentResult  ) ADD_QTMIDI_BASENAME(UseReceivePort) (QTMIDI_GLOBALS() ADD_QTMIDI_COMMA long  portIndex, MusicMIDIReadHookUPP  readHook, long  refCon);
	...
	enum {
		...
		uppQTMIDIUseReceivePortProcInfo = 0x00003FF0
	};
...
*/
	...
	EXTERN_API( ComponentResult  ) ADD_MUSIC_BASENAME(GetInstrumentKnobDescriptionObsolete) (MUSIC_GLOBALS() ADD_MUSIC_COMMA long  knobIndex, void * mkd);

	EXTERN_API( ComponentResult  ) ADD_MUSIC_BASENAME(GetDrumKnobDescriptionObsolete) (MUSIC_GLOBALS() ADD_MUSIC_COMMA long  knobIndex, void * mkd);

	EXTERN_API( ComponentResult  ) ADD_MUSIC_BASENAME(GetKnobDescriptionObsolete) (MUSIC_GLOBALS() ADD_MUSIC_COMMA long  knobIndex, void * mkd);
	...
	EXTERN_API( ComponentResult  ) ADD_MUSIC_BASENAME(ReceiveMIDI) (MUSIC_GLOBALS() ADD_MUSIC_COMMA MusicMIDIReadHookUPP  readHook, long  refCon);
...
/*
	Example usage:
		...
		#define INSTRUMENT_BASENAME()	Fred
		#define INSTRUMENT_GLOBALS()	FredGlobalsHandle
		#include <QuickTimeMusic.k.h>

	To specify that your component implementation does not use globals, do not #define INSTRUMENT_GLOBALS
*/
#ifdef INSTRUMENT_BASENAME
	#ifndef INSTRUMENT_GLOBALS
		#define INSTRUMENT_GLOBALS() 
		#define ADD_INSTRUMENT_COMMA 
	#else
		#define ADD_INSTRUMENT_COMMA ,
	#endif
	#define INSTRUMENT_GLUE(a,b) a##b
	#define INSTRUMENT_STRCAT(a,b) INSTRUMENT_GLUE(a,b)
	#define ADD_INSTRUMENT_BASENAME(name) INSTRUMENT_STRCAT(INSTRUMENT_BASENAME(),name)

	EXTERN_API( ComponentResult  ) ADD_INSTRUMENT_BASENAME(GetInst) (INSTRUMENT_GLOBALS() ADD_INSTRUMENT_COMMA long  instID, AtomicInstrument * atomicInst, long  flags);

	EXTERN_API( ComponentResult  ) ADD_INSTRUMENT_BASENAME(GetInfo) (INSTRUMENT_GLOBALS() ADD_INSTRUMENT_COMMA long  getInstrumentInfoFlags, InstCompInfoHandle * instInfo);

	EXTERN_API( ComponentResult  ) ADD_INSTRUMENT_BASENAME(Initialize) (INSTRUMENT_GLOBALS() ADD_INSTRUMENT_COMMA long  initFormat, void * initParams);

	EXTERN_API( ComponentResult  ) ADD_INSTRUMENT_BASENAME(OpenComponentResFile) (INSTRUMENT_GLOBALS() ADD_INSTRUMENT_COMMA short * resFile);

	EXTERN_API( ComponentResult  ) ADD_INSTRUMENT_BASENAME(CloseComponentResFile) (INSTRUMENT_GLOBALS() ADD_INSTRUMENT_COMMA short  resFile);

	EXTERN_API( ComponentResult  ) ADD_INSTRUMENT_BASENAME(GetComponentRefCon) (INSTRUMENT_GLOBALS() ADD_INSTRUMENT_COMMA void ** refCon);

	EXTERN_API( ComponentResult  ) ADD_INSTRUMENT_BASENAME(SetComponentRefCon) (INSTRUMENT_GLOBALS() ADD_INSTRUMENT_COMMA void * refCon);

	EXTERN_API( ComponentResult  ) ADD_INSTRUMENT_BASENAME(GetSynthesizerType) (INSTRUMENT_GLOBALS() ADD_INSTRUMENT_COMMA OSType * synthesizerType);


	/* MixedMode ProcInfo constants for component calls */
	enum {
		uppInstrumentGetInstProcInfo = 0x00003FF0,
		uppInstrumentGetInfoProcInfo = 0x00000FF0,
		uppInstrumentInitializeProcInfo = 0x00000FF0,
		uppInstrumentOpenComponentResFileProcInfo = 0x000003F0,
		uppInstrumentCloseComponentResFileProcInfo = 0x000002F0,
		uppInstrumentGetComponentRefConProcInfo = 0x000003F0,
		uppInstrumentSetComponentRefConProcInfo = 0x000003F0,
		uppInstrumentGetSynthesizerTypeProcInfo = 0x000003F0
	};

#endif	/* INSTRUMENT_BASENAME */
...
*/
	...
	EXTERN_API( ComponentResult  ) ADD_NA_BASENAME(SetDefaultMIDIInput) (NA_GLOBALS() ADD_NA_COMMA SynthesizerConnections * sc);

	EXTERN_API( ComponentResult  ) ADD_NA_BASENAME(GetDefaultMIDIInput) (NA_GLOBALS() ADD_NA_COMMA SynthesizerConnections * sc);

	EXTERN_API( ComponentResult  ) ADD_NA_BASENAME(UseDefaultMIDIInput) (NA_GLOBALS() ADD_NA_COMMA MusicMIDIReadHookUPP  readHook, long  refCon, unsigned long  flags);

	EXTERN_API( ComponentResult  ) ADD_NA_BASENAME(LoseDefaultMIDIInput) (NA_GLOBALS());
	...
	enum {
		...
		uppNASetDefaultMIDIInputProcInfo = 0x000003F0,
		uppNAGetDefaultMIDIInputProcInfo = 0x000003F0,
		uppNAUseDefaultMIDIInputProcInfo = 0x00003FF0,
		uppNALoseDefaultMIDIInputProcInfo = 0x000000F0,
