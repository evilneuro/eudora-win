...
#define NewPCCardCSClientProc(userRoutine) 						(PCCardCSClientUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppPCCardCSClientProcInfo, GetCurrentArchitecture())
#define CallPCCardCSClientProc(userRoutine, ccPBPtr) 			CALL_ONE_PARAMETER_UPP((userRoutine), uppPCCardCSClientProcInfo, (ccPBPtr))
