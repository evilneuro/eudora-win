/*
 	...
 	Copyright:	© 1993-1998, 1998 by Apple Computer, Inc., all rights reserved.
...
#define PEFRelocComposeSetPosition(fullOffset)	\
...
#define PEFRelocComposeLgByImport(fullIndex)	\
...
#define PEFRelocComposeLgRepeat(chunkCount,fullRepeatCount)	\
...
#define PEFRelocComposeLgSetOrBySection(subopcode,fullIndex)	\
			( 0xB400 | (((UInt16)(subopcode)) << 6) | ((UInt16) (((UInt32)(fullCount)) >> 16) ) )
