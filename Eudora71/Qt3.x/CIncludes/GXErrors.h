...
#define NewgxUserErrorProc(userRoutine) 						(gxUserErrorUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppgxUserErrorProcInfo, GetCurrentArchitecture())
#define NewgxUserWarningProc(userRoutine) 						(gxUserWarningUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppgxUserWarningProcInfo, GetCurrentArchitecture())
#define NewgxUserNoticeProc(userRoutine) 						(gxUserNoticeUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppgxUserNoticeProcInfo, GetCurrentArchitecture())
#define CallgxUserErrorProc(userRoutine, status, refcon) 		CALL_TWO_PARAMETER_UPP((userRoutine), uppgxUserErrorProcInfo, (status), (refcon))
#define CallgxUserWarningProc(userRoutine, status, refcon) 		CALL_TWO_PARAMETER_UPP((userRoutine), uppgxUserWarningProcInfo, (status), (refcon))
#define CallgxUserNoticeProc(userRoutine, status, refcon) 		CALL_TWO_PARAMETER_UPP((userRoutine), uppgxUserNoticeProcInfo, (status), (refcon))
