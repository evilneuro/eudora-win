...
#define NewCollectionFlattenProc(userRoutine) 					(CollectionFlattenUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCollectionFlattenProcInfo, GetCurrentArchitecture())
#define NewCollectionExceptionProc(userRoutine) 				(CollectionExceptionUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppCollectionExceptionProcInfo, GetCurrentArchitecture())
#define CallCollectionFlattenProc(userRoutine, size, data, refCon)  CALL_THREE_PARAMETER_UPP((userRoutine), uppCollectionFlattenProcInfo, (size), (data), (refCon))
#define CallCollectionExceptionProc(userRoutine, c, status) 	CALL_TWO_PARAMETER_UPP((userRoutine), uppCollectionExceptionProcInfo, (c), (status))
/*********************************************/
/************* Public interfaces *************/
/*********************************************/
...
AddCollectionItem				(Collection 			c,
								 ...
								 SInt32 				id,
								 SInt32 				itemSize,
								 void *					itemData)							TWOWORDINLINE(0x7008, 0xABF6);
...
ReplaceIndexedCollectionItem	(Collection 			c,
								 SInt32 				index,
								 SInt32 				itemSize,
								 void *					itemData)							TWOWORDINLINE(0x700D, 0xABF6);
