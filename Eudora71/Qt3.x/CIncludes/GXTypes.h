...
#define NewgxSpoolProc(userRoutine) 							(gxSpoolUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppgxSpoolProcInfo, GetCurrentArchitecture())
#define CallgxSpoolProc(userRoutine, command, block) 			CALL_TWO_PARAMETER_UPP((userRoutine), uppgxSpoolProcInfo, (command), (block))
