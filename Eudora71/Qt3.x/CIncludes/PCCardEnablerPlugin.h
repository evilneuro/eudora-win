...
/*
	NOTE: These prototypes conflict with CardServices.Å
...
enum {
	kUnknownDeviceType			= FOUR_CHAR_CODE('unkn'),
	kDisplayDeviceType			= FOUR_CHAR_CODE('dspl'),
	kBlockDeviceType			= FOUR_CHAR_CODE('blok'),
	kByteDeviceType				= FOUR_CHAR_CODE('byte'),
	kNetworkDeviceType			= FOUR_CHAR_CODE('netw'),
	kSerialDeviceType			= FOUR_CHAR_CODE('ser '),
	kParallelDeviceType			= FOUR_CHAR_CODE('parl'),
	kMemoryDeviceType			= FOUR_CHAR_CODE('mem '),
	kAIMSDeviceType				= FOUR_CHAR_CODE('aims'),
	kSCSIDeviceType				= FOUR_CHAR_CODE('scsi')
};
