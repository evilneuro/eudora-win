...
#define CallDETCallBackProc(userRoutine, callBlockPtr, callBackBlockPtr)  CALL_TWO_PARAMETER_UPP((userRoutine), uppDETCallBackProcInfo, (callBlockPtr), (callBackBlockPtr))
#define NewDETCallBackProc(userRoutine) 						(DETCallBackUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppDETCallBackProcInfo, GetCurrentArchitecture())
/* Call-for list: */
...
#define NewDETCallProc(userRoutine) 							(DETCallUPP)NewRoutineDescriptor((ProcPtr)(userRoutine), uppDETCallProcInfo, GetCurrentArchitecture())
#define CallDETCallProc(userRoutine, callBlockPtr) 				CALL_ONE_PARAMETER_UPP((userRoutine), uppDETCallProcInfo, (callBlockPtr))
