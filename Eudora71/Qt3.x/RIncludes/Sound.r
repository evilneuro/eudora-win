...
#define kWaveInSubType 					'wavi'				/* Windows Wave */
...
#define kWaveOutSubType 				'wavo'				/* Windows Wave */
#define kDirectSoundSubType 			'dsnd'				/* Direct Sound */
...
#define kSoundPortHandlerType 			'soph'				/* sound output port handler component */
#define kAwacsGCSubType 				'awgc'				/* awacs GC port handler */
#define kSoundOutPortType 				'sopt'				/* sound output port component */
#define kIntSpkrSubType 				'ispk'				/* internal speaker */
#define kHeadphonesSubType 				'hdpn'				/* headphones */
#define kExtSpkrSubType 				'espk'				/* external speaker */
#define kEffectSubType 					'efct'				/* effect (like SRS or some other DSP function) */
#define kSubwooferSubType 				'subw'				/* subwoofer */
#define kSoundPowerType 				'spwr'				/* sound power component */
#define kPowerAwacsSubType 				'awac'				/* awacs power */
#define kPowerScreamerSubType 			'scrm'				/* screamer power */
