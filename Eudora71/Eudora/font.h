...
public:
	...
	BOOL CreateFont(LPCTSTR Name, int Points, bool bDeleteOldFont, CDC* pDC = NULL);
	BOOL CreateFontFromMapping(LPCTSTR Name, int nUnMappedSize, bool bDeleteOldFont, CDC* pDC = NULL);
};
