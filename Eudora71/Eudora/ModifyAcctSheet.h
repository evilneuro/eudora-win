...
// Construction
public:
	CModifyAcctSheet(UINT nIDCaption, CWnd* pParentWnd = NULL, UINT iSelectPage = 0, const CString& strName = CRString(IDS_DOMINANT), bool bCreateNew = false);
	CModifyAcctSheet(LPCTSTR pszCaption, CWnd* pParentWnd = NULL, UINT iSelectPage = 0, const CString& strName = CRString(IDS_DOMINANT), bool bCreateNew = false);
