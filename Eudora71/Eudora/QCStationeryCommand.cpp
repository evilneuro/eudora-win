...
void*				pData )
{
	...
	switch( theAction )
	{
		...
		case CA_REPLY_WITH:
			// Message windows have long intercepted this command, and I'm now
			// making CTocFrame also intercept this command so that text selections
			// can be properly handled. As such I'm not actually sure that this
			// will be called any more, but since it's tough to be sure that it
			// won't be called I'm leaving this code alone. - GCW
