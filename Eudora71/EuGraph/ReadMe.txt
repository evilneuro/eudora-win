========================================================================
		ActiveX Control DLL : EUGRAPH
========================================================================

ControlWizard has created this project for your EUGRAPH ActiveX Control
...
that make up your EUGRAPH ActiveX Control DLL.
...
EuGraphCtl.h
	This file contains the declaration of the CEuGraphCtrl C++ class.

EuGraphCtl.cpp
	This file contains the implementation of the CEuGraphCtrl C++ class.

EuGraphPpg.h
	This file contains the declaration of the CEuGraphPropPage C++ class.

EuGraphPpg.cpp
	This file contains the implementation of the CEuGraphPropPage C++ class.

EuGraphCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CEuGraphCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file EuGraph.rc.
